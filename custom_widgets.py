from PyQt6.QtWidgets import QLabel, QVBoxLayout, QFrame, QHBoxLayout, QPushButton, QSpacerItem, QSizePolicy
...
class PartnerContactWidget(QFrame):
    def __init__(self, name, email, phone, org, address, partner_id, main_window):
        ...
        middle_layout.addWidget(self.delete_button, alignment=Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignRight)
